...
| **Diagnostic Policy Service**                | **禁用**      | **诊断服务主机**（包含 `DPS` - Diagnostic Policy Service 等服务）。 |
| **Diagnostic Service Host**                  | **禁用**      | 负责系统问题的检测、诊断以及数据收集。                       |
| **Diagnostic System Host**                   | **禁用**      | 在后台监控系统组件状态、收集硬件与系统级别的崩溃诊断数据，并配合 Windows 疑难解答工具工作。 |
...
winget uninstall "Xbox 主机小帮手"
winget uninstall "Game Bar"
winget uninstall "邮件和日历"
winget uninstall "开发人员主页"
...
$AppsList = @(
    ...
    "Microsoft.Wallet"                       # Microsoft OneDrive
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.Microsoft3DViewer*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.MicrosoftStickyNotes*"} | Remove-AppxProvisionedPackage -Online
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.MixedReality.Portal*"} | Remove-AppxProvisionedPackage -Online
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.Office.OneNote*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.SkypeApp*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.Wallet*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.WindowsAlarms*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.windowscommunicationsapps*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.WindowsMaps*"} | Remove-AppxProvisionedPackage -Online
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.WindowsSoundRecorder*"} | Remove-AppxProvisionedPackage -Online
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.Xbox*"} | Remove-AppxProvisionedPackage -Online
...
Get-AppxProvisionedPackage -Online | Where-Object {$_.DisplayName -like "*Microsoft.Zune*"} | Remove-AppxProvisionedPackage -Online
...
- **清理此电脑下的现实**
  ...
  | **子项名称 (CLSID)**                     | **对应的系统文件夹 / 功能**  |
  | ---------------------------------------- | ---------------------------- |
  | `{0DB7E03F-FC29-4DC6-9020-FF41B59E513A}` | **3D 对象** (3D Objects)     |
  | `{0DDD015D-B061-4729-8CD0-58D928C62723}` | **下载** (Downloads)         |
  | `{0B2FE9D4-05D9-419E-A638-026E3E9614C6}` | **文档** (Documents)         |
  | `{1CF1266C-433E-42E6-869E-A77866AC2A00}` | **音乐** (Music)             |
  | `{3ADD162A-9210-45DA-864B-4411563283BC}` | **图片** (Pictures)          |
  | `{A0953C92-50DC-43BF-BE83-3742FED03C9C}` | **视频** (Videos)            |
  | `{B4BF8809-9D08-4E4C-A83B-280E3F831160}` | **桌面** (Desktop)           |
  | `{21EC2020-3AEA-1069-A2DD-08002B30309D}` | **控制面板** (Control Panel) |
...
- 查询后把文件拷贝到 D盘：
  ...
  ```
  powercfg /batteryreport
  COPY C:\Windows\system32\battery-report.html D:\.
