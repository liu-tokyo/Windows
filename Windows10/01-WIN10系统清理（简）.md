...
$AppsList = @(
    ...
    "Microsoft.WindowsCalculator"            # 3D Windows 计算器
    "Microsoft.ScreenSketch"                 # 截图和草图
    "Microsoft.549981C3F5F10"                # Cortana
    "Microsoft.WindowsMaps"                  # 地图
    "Microsoft.MixedReality.Portal"          # 混合门户
    "*Xbox*"                                 # Xbox
    "*OneNote*"                              # OneNote
)
...
- 使用如下指令，把所有组件更新到最新状态：
  ...
  如果使用 imdisk 的内存盘作为缓存目录的话，可能会出现错误，使用如下指令重新定义临时缓存目录：
